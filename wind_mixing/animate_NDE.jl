...
animate_profile_flux(plot_data, "u", "uw", joinpath(FILE_PATH, "u_uw_convective_adjustment_1sim_-1e-3_2_temp"))
animate_profile_flux(plot_data, "v", "vw", joinpath(FILE_PATH, "v_vw_convective_adjustment_1sim_-1e-3_2_temp"))
animate_profile_flux(plot_data, "T", "wT", joinpath(FILE_PATH, "w_wT_convective_adjustment_1sim_-1e-3_2_temp"))
