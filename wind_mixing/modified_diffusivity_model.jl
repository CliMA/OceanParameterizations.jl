...
KU(Ri, ν₋, Riᶜ) = ν₋ / (1 + tanh(Ri - Riᶜ))
KT(Ri, ν₋, Riᶜ, Pr) = KU(Ri, ν₋, Riᶜ) / Pr

# KU(Ri, ν₀, ν₋, Riᶜ, ΔRi) = ν₀ + ν₋ * tanh_step((Ri - Riᶜ) / ΔRi)
# KT(Ri, ν₀, ν₋, Riᶜ, ΔRi, Pr) = KU(Ri, ν₀, ν₋, Riᶜ, ΔRi) / Pr

KU(m, i) = KU(local_richardson(m, i), m.parameters.Cν₋, m.parameters.Riᶜ)
KT(m, i) = KT(local_richardson(m, i), m.parameters.Cν₋, m.parameters.Riᶜ, m.parameters.Pr)
