...
train_files = ["wind_-5e-4_cooling_1e-8_new"]
𝒟 = WindMixing.data(train_files, scale_type=ZeroMeanUnitVarianceScaling, enforce_surface_fluxes=false)

NDE_profile_path = joinpath(pwd(), "final_results", "18sim_old", "train_$(train_files[1])", "profiles_fluxes_oceananigans.jld2")
...
FILE_PATH = joinpath(pwd(), "Output", "test_base")
fps=30
