...
# KU() = 0
# KT(Ri, ν₀, ν₋, Riᶜ, ΔRi, Pr) = (ν₀ + ν₋ * tanh_step((Ri - Riᶜ) / ΔRi)) / Pr
# KU(m, i) = KU()
...
KU(m, i) = KU(local_richardson(m, i), m.parameters.Cν₀, m.parameters.Cν₋, m.parameters.Riᶜ, m.parameters.ΔRi)
KT(m, i) = KT(local_richardson(m, i), m.parameters.Cν₀, m.parameters.Cν₋, m.parameters.Riᶜ, m.parameters.ΔRi, m.parameters.Pr)
