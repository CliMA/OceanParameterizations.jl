...
uw_weights = BSON.load(joinpath(PATH, "Output", "uw_NDE_weights_2DaySuite_2Sims.bson"))[:weights]
vw_weights = BSON.load(joinpath(PATH, "Output", "vw_NDE_weights_2DaySuite_2Sims.bson"))[:weights]
wT_weights = BSON.load(joinpath(PATH, "Output", "wT_NDE_weights_2DaySuite_2Sims.bson"))[:weights]
...
function save_NDE_weights()
    ...
    bson(joinpath(PATH, "Output", "uw_NDE_weights_2DaySuite_2Sims_200.bson"), uw_NN_params)

    vw_NN_params = Dict(:weights => vw_weights)
    bson(joinpath(PATH, "Output", "vw_NDE_weights_2DaySuite_2Sims_200.bson"), vw_NN_params)

    wT_NN_params = Dict(:weights => wT_weights)
    bson(joinpath(PATH, "Output", "wT_NDE_weights_2DaySuite_2Sims_200.bson"), wT_NN_params)
end
