...
DATA_NAMES = [
  "NDE_18sim_windcooling_windheating_18simBFGST0.8grad_divide1f5_gradient_smallNN_leakyrelu_rate_2e-4_T0.8"
]

EXTRACTED_DATA_DIR = joinpath(pwd(), "extracted_training_output")
OUTPUT_DIR = joinpath("C:\\Users\\xinle\\Documents\\OceanParameterizations.jl")
...
for DATA_NAME in DATA_NAMES
    animate_training_results(test_files, DATA_NAME,
                         EXTRACTED_DATA_DIR=EXTRACTED_DATA_DIR, OUTPUT_DIR=OUTPUT_DIR, convective_adjustment=true)
end